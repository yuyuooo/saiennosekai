module NotificationsHelper
  ...
  def notification_form(notification)
    ...
    case notification.action
      ...
      when "like" then
        tag.a(@visitor.name, href:user_about_path(@visitor), style:"font-weight: bold;")+"が"+tag.a('あなたの商品', href:item_path(notification.item_id), style:"font-weight: bold;")+"に「気になる」しました"
    end
  end
end
